...
#define and get info on info needed policies for both roles
data "aws_iam_policy" "AmazonSSMManagedInstanceCore" {
  #arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstance"
  arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

data "aws_iam_policy" "AmazonEC2ContainerRegistyFullAccess" {
...
resource "aws_iam_role_policy_attachment" "policy-attach-ecr-full" {
  role       = aws_iam_role.app-server-role.name
  policy_arn = data.aws_iam_policy.AmazonEC2ContainerRegistyFullAccess.arn
}
